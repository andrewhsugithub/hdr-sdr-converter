...
def process_video(input_path, output_path):
    ...
    print(f"Converting HLG -> PQ: {input_path} -> {output_path}")
    ...
    for frame in input_container.decode(in_stream):
        ...
        # D. Normalize for PQ
        # PQ is absolute. We must map "Nits" to 0.0-1.0.
        # Standard: 10000 nits = 1.0 signal.
        rgb_linear_normalized = rgb_display_linear * (1000.0 / 10000.0)
...
output_path = os.path.join(output_dir, "test_hlg2pq.mp4")
